            ...
            @else
                <form method="POST" action="{{ url('/supplier/' . $supplier->supplier_id) }}" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label class="col-1 control-label col-form-label">Kode Supplier</label> <!-- Mengganti Kategori -->
                        <div class="col-11">
                    ...
                    <div class="form-group row">
                        <label class="col-1 control-label col-form-label">Nama Supplier</label> <!-- Mengganti Kategori -->
                        <div class="col-11">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            ...
                            <a class="btn btn-sm btn-default ml-1" href="{{ url('supplier') }}">Kembali</a> <!-- Mengganti Kategori -->
                        </div>
                    </div>
                </form>
            @endempty
